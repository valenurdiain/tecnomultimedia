...
musica.loop();
    ...
    //comienzo a cargar las pantallas, con los botones correspondientes
    pantalla = 0; 
                                                                //ubicacion               //pantalla a la que se dirige al tocar el boton
...
//como? no escuche
  ...
  //dibujo la pantalla donde inicia a aventura, que puse al final de los botones
  void dibujar() {
